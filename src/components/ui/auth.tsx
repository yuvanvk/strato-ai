...
export const Auth = () => {
    ...
    return <div className="h-screen flex items-center justify-center bg-white dark:bg-[#101010] font-mono">
        <div className="flex flex-col items-center space-y-4">
                ...
                <button className="bg-gradient-to-b from-[#5728f4] to-[#5100FF] hover:opacity-90 text-white min-w-sm py-3 [box-shadow:0px_-2px_0px_-0px_#2c04b1_inset] rounded-[15px] flex items-center gap-2 font-medium justify-center cursor-pointer">
                    <FcGoogle size={25}/>
